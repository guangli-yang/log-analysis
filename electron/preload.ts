...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  openSyncPanel: () => ipcRenderer.invoke('open-sync-panel')
})
...
declare global {
  interface Window {
    electronAPI: {
      ...
      selectCodeFolder: (patterns: Array<{ pattern: string; enabled: boolean }>) => Promise<{ folderPath: string; results: Array<{ filePath: string; content: string; fileName: string; line: number; functionName: string; matchedPattern: string; matchedText: string }> } | null>
